...
export declare const weaponCategories: readonly ["Primary", "Secondary"];
...
export declare const domainNames: readonly ["Arcana", "Blade", "Bone", "Codex", "Dread", "Grace", "Midnight", "Sage", "Splendor", "Valor"];
